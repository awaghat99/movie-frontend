...
const MovieCard = (props) => {
  ...
  return (
    <div
      ...
      className={`bg-cover bg-center relative px-2 py-2 w-[22%] aspect-[2] rounded-md flex items-end cursor-pointer max-sm:w-[48%] max-sm:items-center max-sm:text-center max-sm:justify-center ${
